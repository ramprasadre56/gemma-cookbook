"""
Extract Tree Species - Using proven clustering logic
Processes pages 54-61 (0-indexed: 53-60)
"""
import fitz
import json
import os
...
OUTPUT_DIR = "assets/heartyculture_catalogue/tree_species"
PAGES = [53, 54, 55, 56, 57, 58, 59, 60]  # 0-indexed (pages 54-61)
    ...
    for page_num in PAGES:
        ...
        for idx, plant in enumerate(plants):
            ...
            if idx < len(images):
                ...
                entry['image'] = f"/heartyculture_catalogue/tree_species/{filename}"
