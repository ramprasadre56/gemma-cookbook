"""
Extract Coconut Varieties - Using proven clustering logic
Processes pages 62-63 (0-indexed: 61-62)
"""
import fitz
import json
import os
...
OUTPUT_DIR = "assets/heartyculture_catalogue/coconut_varieties"
PAGES = [61]  # 0-indexed (page 62 only - page 63 has Mango varieties)
...
def extract_page(doc, page_num):
    ...
    skip_patterns = [
        ...
        r'^Coconut Varieties$', r'^Coconut varieties$'
    ]
    ...
    for page_num in PAGES:
        ...
        for idx, plant in enumerate(plants):
            ...
            if idx < len(images):
                ...
                entry['image'] = f"/heartyculture_catalogue/coconut_varieties/{filename}"
