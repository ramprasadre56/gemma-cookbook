"""
Extract Mango Varieties - Using proven clustering logic
Processes page 63 (0-indexed: 62)
"""
import fitz
import json
import os
...
OUTPUT_DIR = "assets/heartyculture_catalogue/mango_varieties"
PAGES = [62, 63]  # 0-indexed (pages 63-64)
...
def extract_page(doc, page_num):
    ...
    skip_patterns = [
        ...
        r'^Mango Varieties$', r'^Mango varieties$'
    ]
    ...
    for page_num in PAGES:
        ...
        for idx, plant in enumerate(plants):
            ...
            if idx < len(images):
                ...
                entry['image'] = f"/heartyculture_catalogue/mango_varieties/{filename}"
