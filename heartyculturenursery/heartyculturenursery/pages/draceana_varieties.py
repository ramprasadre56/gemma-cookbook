"""Draceana Varieties Category Page"""
import reflex as rx
...
PLANT_CATEGORIES = [
    ...
    {"name": "Draceana Varieties", "route": "/plants/draceana-varieties", "icon": "tree_palm", "active": True},
...
class DraceanaState(rx.State):
    """State for the Draceana Varieties page."""
    plants: list[dict] = []
    search_query: str = ""
    ...
    def load_plants(self):
        ...
        try:
            json_path = Path("assets/heartyculture_catalogue/draceana_varieties/plants.json")
...
def draceana_varieties() -> rx.Component:
    """Draceana Varieties category page with sidebar navigation."""
    return rx.box(
        navbar(),
        # Header section
        rx.box(
            rx.vstack(
                ...
                rx.hstack(
                    ...
                    rx.icon("chevron-right", size=16, color="#999"),
                    rx.text("Draceana Varieties", color="#22c55e", font_size="1em", font_weight="500"),
                    spacing="2",
                    align="center",
                ),
                ...
                rx.hstack(
                    rx.box(
                        rx.icon("tree_palm", size=24, color="white"),
                        padding="12px",
                    ...
                    rx.vstack(
                        ...
                        rx.text(
                            rx.text.span(DraceanaState.plant_count),
            ...
            rx.box(
                ...
                rx.box(
                    rx.hstack(
                        ...
                        rx.input(
                            placeholder="Search draceana varieties...",
                            value=DraceanaState.search_query,
                            on_change=DraceanaState.set_search_query,
                            border="none",
                            outline="none",
                            width="100%",
                            font_size="1.1em",
