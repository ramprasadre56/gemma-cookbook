"""Flowering Shrubs Category Page"""
import reflex as rx
...
PLANT_CATEGORIES = [
    {"name": "Flowering Shrubs", "route": "/plants/flowering-shrubs", "icon": "flower-2", "active": True},
...
class FloweringShrubsState(rx.State):
    """State for the Flowering Shrubs page."""
    plants: list[dict] = []
    search_query: str = ""
    ...
    def load_plants(self):
        ...
        try:
            json_path = Path("assets/heartyculture_catalogue/flowering_shrubs/plants.json")
...
def sidebar_category_item(cat: dict) -> rx.Component:
    ...
    return rx.link(
        ...
        padding="6px 8px",
        border_radius="6px",
        background="rgba(34, 197, 94, 0.12)" if is_active else "transparent",
...
def category_sidebar() -> rx.Component:
    ...
    return rx.box(
        ...
        display=["none", "none", "none", "block"],  # Hide on mobile/tablet
    )


def plant_card(plant: dict) -> rx.Component:
    """Modern plant card with image and details."""
    return rx.box(
        rx.vstack(
            # Image container
            rx.box(
...
def flowering_shrubs() -> rx.Component:
    """Flowering Shrubs category page with sidebar navigation."""
    return rx.box(
        navbar(),
        # Header section
        rx.box(
            rx.vstack(
                ...
                rx.hstack(
                    ...
                    rx.icon("chevron-right", size=16, color="#999"),
                    rx.text("Flowering Shrubs", color="#22c55e", font_size="1em", font_weight="500"),
                    spacing="2",
                    align="center",
                ),
                ...
                rx.hstack(
                    rx.box(
                        rx.icon("flower-2", size=24, color="white"),
                        padding="12px",
                    ...
                    rx.vstack(
                        ...
                        rx.text(
                            rx.text.span(FloweringShrubsState.plant_count),
            ...
            rx.box(
                ...
                rx.box(
                    rx.hstack(
                        ...
                        rx.input(
                            placeholder="Search flowering shrubs...",
                            value=FloweringShrubsState.search_query,
                            on_change=FloweringShrubsState.set_search_query,
                            border="none",
                            outline="none",
                            width="100%",
                            font_size="1.1em",
                    ...
                    max_width="350px",
                    margin_bottom="1.5em",
                    _focus_within={"border_color": "#22c55e", "box_shadow": "0 0 0 3px rgba(34, 197, 94, 0.1)"},
                ),
                
                # Plants grid
                rx.box(
                    rx.foreach(
                        FloweringShrubsState.filtered_plants,
                        lambda plant: plant_card(plant),
                    ),
                    display="grid",
