"""
Extract Commercial Timber Plants - Using proven clustering logic
Processes page 65 (0-indexed: 64)
"""
import fitz
import json
import os
...
OUTPUT_DIR = "assets/heartyculture_catalogue/commercial_timber"
PAGES = [64]  # 0-indexed (page 65)
...
def extract_page(doc, page_num):
    ...
    skip_patterns = [
        ...
        r'^Commercial timber plants for farmers$', r'^Commercial timber plants$'
    ]
...
def extract_timber():
    ...
    print("\nCommercial Timber Plants Extraction")
    print("=" * 60)
    ...
    for page_num in PAGES:
        ...
        for idx, plant in enumerate(plants):
            ...
            entry = {
                ...
                'category': 'Commercial Timber Plants',
                'page': page_num + 1,
            }
            ...
            if idx < len(images):
                ...
                entry['image'] = f"/heartyculture_catalogue/commercial_timber/{filename}"
