"""
Extract Ginger Varieties - Single name format
Processes page 44 (0-indexed: 43)
"""
import fitz
import json
import os
...
OUTPUT_DIR = "assets/heartyculture_catalogue/ginger_varieties"
PAGES = [43]
...
def extract_ginger():
    ...
    for page_num in PAGES:
        ...
        for idx, name in enumerate(names):
            ...
            entry = {
                'id': plant_id,
                'scientific_name': 'Zingiber',
                'common_name': name['name'],
                'category': 'Ginger Varieties',
                'page': page_num + 1,
            }
            ...
            if idx < len(images):
                ...
                entry['image'] = f"/heartyculture_catalogue/ginger_varieties/{filename}"
                print(f"      {name['name']}")
