"""
Extract Fruit Varieties - Using proven clustering logic
Processes pages 36-43 (0-indexed: 35-42)
"""
import fitz
import json
import os
...
OUTPUT_DIR = "assets/heartyculture_catalogue/fruit_varieties"
PAGES = [35, 36, 37, 38, 39, 40, 41, 42]  # 0-indexed (pages 36-43)
...
def extract_page(doc, page_num):
    ...
    skip_patterns = [
        ...
        r'^Fruit Varieties$', r'^Fruit varieties$'
    ]
    ...
    for page_num in PAGES:
        ...
        for idx, plant in enumerate(plants):
            ...
            if idx < len(images):
                ...
                entry['image'] = f"/heartyculture_catalogue/fruit_varieties/{filename}"
