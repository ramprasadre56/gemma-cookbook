"""
Extract Sacred Trees - Using proven clustering logic
Processes pages 52-53 (0-indexed: 51-52)
"""
import fitz
import json
import os
...
OUTPUT_DIR = "assets/heartyculture_catalogue/sacred_trees"
PAGES = [51, 52]  # 0-indexed (pages 52-53)
    ...
    for page_num in PAGES:
        ...
        for idx, plant in enumerate(plants):
            ...
            if idx < len(images):
                ...
                entry['image'] = f"/heartyculture_catalogue/sacred_trees/{filename}"
