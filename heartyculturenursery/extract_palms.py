"""
Extract Palm Varieties - Using proven clustering logic
Processes pages 46-48 (0-indexed: 45-47)
"""
import fitz
import json
import os
...
OUTPUT_DIR = "assets/heartyculture_catalogue/palm_varieties"
PAGES = [45, 46, 47]  # 0-indexed (pages 46-48)
...
def extract_page(doc, page_num):
    ...
    skip_patterns = [
        ...
        r'^Palm Varieties$', r'^Palm varieties$'
    ]
    ...
    for page_num in PAGES:
        ...
        for idx, plant in enumerate(plants):
            ...
            if idx < len(images):
                ...
                entry['image'] = f"/heartyculture_catalogue/palm_varieties/{filename}"
