"""
Extract Climbers & Creepers - Using proven clustering logic
Processes pages 29-35 (0-indexed: 28-34)
"""
import fitz
import json
import os
...
OUTPUT_DIR = "assets/heartyculture_catalogue/climbers_creepers"
PAGES = [28, 29, 30, 31, 32, 33, 34]  # 0-indexed (pages 29-35)
...
def extract_climbers():
    doc = fitz.open(PDF_PATH)
    
    print("\nClimbers & Creepers Extraction")
    print("=" * 60)
    ...
    for page_num in PAGES:
        ...
        for idx, plant in enumerate(plants):
            ...
            if idx < len(images):
                ...
                entry['image'] = f"/heartyculture_catalogue/climbers_creepers/{filename}"
